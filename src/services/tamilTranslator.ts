...
const TAMIL_DICTIONARY: Record<string, string> = {
  ...
  'அதிபர்': 'principal',
  'செயலாளர்': 'secretary',
  'பொருட்களின் விபரம்': 'items_description',
  'பொருட்களின் விவரம்': 'items_description',
  'அளவீட்டு அலகு': 'unit_of_measure',
  'அலகு': 'unit',
  'பெறப்பட்ட திகதி': 'received_date',
  'பெறப்பட்ட தேதி': 'received_date',
  'வழங்கப்பட்ட திகதி': 'issued_date',
  'வழங்கப்பட்ட தேதி': 'issued_date',
  'இடமாற்றம்': 'transfer',
  'நீக்கம்': 'disposal_writeoff',
  'நிலைமை': 'condition',
  'நல்ல நிலை': 'good_condition',
  'பழுது': 'damaged',
  'திருத்தப்பட வேண்டியது': 'repair_needed',
  'பயன்பாடற்றது': 'unusable',
  'அலுவலக உபயோகத்திற்கு': 'for_office_use',
  'காரியாலய உபயோகத்திற்கு': 'for_office_use',
  'தீர்மானம்': 'decision',
  'விடயம்': 'subject_matter',
  'பதிவேடு': 'register',
  'தொகுப்பு': 'volume_collection',
